...
public sealed class RozetkaCommentsResponse
{
    ...
    public sealed class Record
    {
        ...
        public required string fulltitle { get; init; } = string.Empty;
        public required UsersRating users_rating { get; init; }

        public sealed class UsersRating
        {
            public int count_comments { get; init; }
        }
    }
